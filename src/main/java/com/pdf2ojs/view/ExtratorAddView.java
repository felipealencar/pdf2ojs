...
public class ExtratorAddView extends javax.swing.JFrame {
     ...
     * @param metaPapers
     */
    public ExtratorAddView(ExtractorView parent, List<ArticleMeta> metaPapers) {
        initComponents();
        initAuthorNames();
        
        // Cria ArticleMeta vazio
        ArticleMeta articleMeta = new ArticleMeta();
        articleMeta.setAbstractText("");
        articleMeta.setTitle("");
        ...
        this.metapapers.add(articleMeta);
        System.err.println("Adicionei articleMeta e ficou " + this.metapapers.size());
    ...
    private void saveFields(int index) {
        ...
        int authorIndex = 0;
        this.metapapers.get(index).getPdf().getName();
        this.metapapers.get(index).setTitle(titleTextField.getText());
        this.metapapers.get(index).setAbstractText(abstractTextArea.getText());
        ...
        for (JTextField authorName : authorNames) {
            if (!authorName.getText().isEmpty()) {
                ...
                System.out.println("Paper: " + this.metapapers.get(index).getTitle());
                System.out.println("Saving authors:\n");
                System.out.println("- " + cm.getName());
            }
        }

        this.metapapers.get(index).setAuthors(authors);
    }
...
private void initAuthorNames() {
    ...
    private void initComponents() {
        ...
        filenameTextField.setFont(new java.awt.Font("Lato Medium", 0, 14)); // NOI18N
        filenameTextField.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 1, true));
        ...
        TitleLabel1.setFont(new java.awt.Font("Lato Black", 0, 14)); // NOI18N
        TitleLabel1.setText("File Name");
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(saveButton)
                    .addComponent(filenameTextField, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(TitleLabel1))
